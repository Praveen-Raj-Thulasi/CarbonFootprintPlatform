...
const achievements = [
  { icon: TreePine, label: "15 Trees Saved", color: "text-emerald-500" },
  { icon: Car, label: "900 km Avoided", color: "text-blue-500" },
  { icon: Zap, label: "8 Mo Energy", color: "text-amber-500" },
];
          ...
          <Card className="aspect-[1/1.58] rounded-[3rem] bg-white border-none shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] flex flex-col p-12 overflow-hidden relative">
            ...
            <div className="flex flex-col items-center mb-16">
               <div className="w-24 h-24 rounded-full bg-slate-100 flex items-center justify-center mb-6 overflow-hidden border-4 border-white shadow-sm">
                 <div className="w-full h-full bg-[url('https://api.dicebear.com/7.x/avataaars/svg?seed=Alex')] bg-cover" />
               </div>
               <h2 className="text-3xl font-bold text-[#1D1D1F] tracking-tight">Alex Rivet</h2>
            ...
            <div className="flex justify-between items-end pt-12 border-t border-slate-50">
               <div>
                  ...
                  <p className="text-sm font-mono font-bold text-black">CIQ • 8829</p>
               </div>
